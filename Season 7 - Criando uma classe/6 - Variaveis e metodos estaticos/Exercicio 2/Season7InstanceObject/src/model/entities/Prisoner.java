...
public class Prisoner {
  ...
  public Prisoner() {
    ...
    Prisoner.bookingNumber = Prisoner.prisonerCount;
  }
  ...
  public static Integer getPrisonerCount() {
    return prisonerCount;
  }

  public static void setPrisonerCount(Integer prisonerCount) {
    Prisoner.prisonerCount = prisonerCount;
  }

  public static String displayStaticInfo() {
    return "Prisoner Count: " + Prisoner.prisonerCount + " - " + "Booking Number: " + Prisoner.bookingNumber;
  }
